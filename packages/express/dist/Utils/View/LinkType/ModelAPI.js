...
function getLinkApiModelList(modelKey, refModelKey, refModelValue) {
  let url = `${(0, _Mount.getMountPath)() + _adminInterfaceMnCore.Registry.getRepository('Config').get('apiPath') + _adminInterfaceMnCore.Registry.getRepository('Config').get('modelPath')}/${modelKey}/list`;
...
function getLinkApiModelDelete(modelKey, single) {
  return `${(0, _Mount.getMountPath)() + _adminInterfaceMnCore.Registry.getRepository('Config').get('apiPath') + _adminInterfaceMnCore.Registry.getRepository('Config').get('modelPath')}/${modelKey}/single/${single}/delete`;
}
...
function getLinkApiModelCreate(modelKey) {
  return `${(0, _Mount.getMountPath)() + _adminInterfaceMnCore.Registry.getRepository('Config').get('apiPath') + _adminInterfaceMnCore.Registry.getRepository('Config').get('modelPath')}/${modelKey}/create`;
}
...
function getLinkApiModelSingleUpdate(modelKey, single) {
  return `${(0, _Mount.getMountPath)() + _adminInterfaceMnCore.Registry.getRepository('Config').get('apiPath') + _adminInterfaceMnCore.Registry.getRepository('Config').get('modelPath')}/${modelKey}/single/${single}/update`;
}